...
class FacetEnumeration(BaseModel):
    """
    FacetEnumeration
    """ # noqa: E501
    name: Optional[StrictStr] = None
    facets: Optional[List[FacetValueEnumeration]] = None
    __properties: ClassVar[List[str]] = ["name", "facets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "facets": [FacetValueEnumeration.from_dict(_item) for _item in obj["facets"]] if obj.get("facets") is not None else None
        })
        return _obj
