...
class GetDatasets429Response(BaseModel):
    """
    GetDatasets429Response
    """ # noqa: E501
    errorcode: Union[StrictFloat, StrictInt]
    reset_time: Annotated[str, Field(min_length=1, strict=True)]
    limit_time_unit: Annotated[str, Field(min_length=1, strict=True)]
    call_limit: Union[StrictFloat, StrictInt]
    error: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[List[str]] = ["errorcode", "reset_time", "limit_time_unit", "call_limit", "error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "limit_time_unit": obj.get("limit_time_unit"),
            "call_limit": obj.get("call_limit"),
            "error": obj.get("error")
        })
        return _obj
