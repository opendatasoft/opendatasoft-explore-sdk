...
from opendatasoft_explore_async.api_response import ApiResponse, T as ApiResponseT
import opendatasoft_explore_async.models
from opendatasoft_explore_async import rest
from opendatasoft_explore_async.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/21.0.1/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(opendatasoft_explore_async.models, klass)
