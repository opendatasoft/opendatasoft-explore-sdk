...
async with opendatasoft_explore_async.ApiClient(configuration) as api_client:
    ...
    include_exports = opendatasoft_explore_async.EnumFormatDatasetsV21() # EnumFormatDatasetsV21 | Sets the datasets exports exposed in the DCAT export. By default, all exports are exposed. (optional)
