    ...
    def make_instance(self, include_optional) -> Datasets:
        ...
        if include_optional:
            return Datasets(
                ...
                results = [
                    opendatasoft_explore.models.dataset.dataset(
                        _links = [
                            opendatasoft_explore.models.links.links(
                                href = '', 
                                rel = 'self', )
                        ...
                        dataset_uid = '', 
                        attachments = [
                            opendatasoft_explore.models.dataset_attachments_inner.dataset_attachments_inner(
                                mimetype = '', 
                                url = '', 
                                id = '', 
                                title = '', )
                        ...
                        metas = opendatasoft_explore.models.metas.metas(), 
                        fields = [
                            opendatasoft_explore.models.dataset_fields_inner.dataset_fields_inner(
                                name = '', 
                                label = '', 
                                type = '', 
