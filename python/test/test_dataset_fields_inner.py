...
class TestDatasetFieldsInner(unittest.TestCase):
    """DatasetFieldsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DatasetFieldsInner:
        """Test DatasetFieldsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DatasetFieldsInner`
        """
        model = DatasetFieldsInner()
        if include_optional:
            return DatasetFieldsInner(
                name = '',
                label = '',
                type = '',
    ...
    def testDatasetFieldsInner(self):
        """Test DatasetFieldsInner"""
