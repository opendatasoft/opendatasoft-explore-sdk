...
from opendatasoft_explore.api_response import ApiResponse, T as ApiResponseT
import opendatasoft_explore.models
from opendatasoft_explore import rest
from opendatasoft_explore.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(opendatasoft_explore.models, klass)
