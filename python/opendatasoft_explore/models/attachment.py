...
class Attachment(BaseModel):
    ...
    metas: Optional[AttachmentMetas] = None
    __properties: ClassVar[List[str]] = ["href", "metas"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of metas
        if self.metas:
            _dict['metas'] = self.metas.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "href": obj.get("href"),
            "metas": AttachmentMetas.from_dict(obj["metas"]) if obj.get("metas") is not None else None
        })
        return _obj
